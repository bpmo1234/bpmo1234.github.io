...
const NowPlaying = async () => {
  const res = await fetch(
    "https://api.themoviedb.org/3/list/8248299?page=1&api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR"
  );
...
const TodayTrending = async () => {
  const res = await fetch(
    "https://api.themoviedb.org/3/list/8248355?page=1&api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR"
  );
  const data = await res.json();
...
const popularnow = async () => {
  const res = await fetch(
    `https://api.themoviedb.org/3/list/8248353?page=1&api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR`
  );
  const data = await res.json();
...
const Toprated = async () => {
  const res = await fetch(
    `https://api.themoviedb.org/3/list/8248354?page=1&api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR`
  );
  const data = await res.json();
