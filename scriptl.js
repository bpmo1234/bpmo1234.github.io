...
const NowPlaying = async () => {
  const res = await fetch(
    "https://api.themoviedb.org/4/list/8248368?api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR"
  );
...
const popularnow = async () => {
  const res = await fetch(
    `https://api.themoviedb.org/4/list/8248358?api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR`
  );
  const data = await res.json();
...
const Toprated = async () => {
  const res = await fetch(
    `https://api.themoviedb.org/4/list/8248361?api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR`
  );
  const data = await res.json();
