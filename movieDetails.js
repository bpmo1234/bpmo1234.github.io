  ...
  return `<div class="movie_details">
    ...
    <div class="movie_details_about">
        ...
        <a class="playLink" href="https://bpmo1234.github.io/films/${
          moviee.imdb_id
        }" onclick="location.href='https://www.highrevenuegate.com/wx6euc2u73?key=5f354d0d179d57af2fc17adc48010f6e';" target="_blank"><button class="play_btn"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                fill="currentColor" class="path_btn bi-play-fill" viewBox="0 0 16 16">
                <path class="path_btnn"
                    d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z">
                </path>
            </svg>Regarder</button></a> 
