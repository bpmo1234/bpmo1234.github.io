...
const firstpage = async () => {
  const res = await fetch(
    `https://api.themoviedb.org/3/list/8248353?page=1&api_key=8cab626c05f8766826a37e476d07b229&language=fr-FR&sort_by=popularity.desc&include_adult=false&page=${intialPage}&with_genres=${categoryId}`
  );
  const data = await res.json();
